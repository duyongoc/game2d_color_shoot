...
namespace Pools
{
    public static class PoolHelper
    {
        ...
        {
            return Pool.GetInstancePrefab();
        }
       
	   
	    public static Dictionary<GameObject, Pool> GetInstanceLookup()
        {
            return Pool.GetInstanceLookup();
        }


        public static void InitPoolPrefab(this GameObject prefab, int count)
        {
            Pool.GetPrefabPool(prefab).InitPoolPrefab(count);
        }


        public static void InitPoolPrefab(this GameObject prefab, int count, Transform parent)
        {
            Pool.GetPrefabPool(prefab).InitPoolPrefab(count, parent);
        }
